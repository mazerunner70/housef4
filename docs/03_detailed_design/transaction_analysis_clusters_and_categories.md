...
Today, [`backend/src/services/import/runImportPlanning.ts`](../../backend/src/services/import/runImportPlanning.ts) orchestrates planning (stages 7–9); cluster/category logic lives under [`backend/src/services/import/clustering/`](../../backend/src/services/import/clustering/) — primarily [`clusterPipeline.ts`](../../backend/src/services/import/clustering/clusterPipeline.ts) (embed → DBSCAN → categorise), with supporting modules [`merchantNormalize.ts`](../../backend/src/services/import/clustering/merchantNormalize.ts), [`merchantsEmbedder.ts`](../../backend/src/services/import/clustering/merchantsEmbedder.ts), [`dbscanCosine.ts`](../../backend/src/services/import/clustering/dbscanCosine.ts), [`clusterIdentity.ts`](../../backend/src/services/import/clustering/clusterIdentity.ts), [`categoryClassifier.ts`](../../backend/src/services/import/clustering/categoryClassifier.ts), and [`taxonomyV2.ts`](../../backend/src/services/import/clustering/taxonomyV2.ts) (public barrel: [`clustering/index.ts`](../../backend/src/services/import/clustering/index.ts)). Historically the import path used:
